...
<div class=" top-nav rsidebar span_1_of_left">
 ...
 <ul class="menu">
<li class="item1"><a href="#">CLOTHING<img class="arrow-img" src="images/arrow1.png" alt=""/> </a>
	<ul class="cute">
		<li class="subitem1"><a href="product.html">Tops, Tees & Shirt </a></li>
		<li class="subitem2"><a href="product.html">Dresses </a></li>
		<li class="subitem3"><a href="product.html">Sweaters </a></li>
	</ul>
</li>
