	...
	<div class="header">
		...
		<div class="bottom-header">
			<div class="container">
				...
				<div class="header-bottom-right" style="width: 33%;float: right: ;"  >					
						<div class="cart" style="width: 60%;">&nbsp;</div>
						<div class="cart" style="width: 20%;"><a href=" <c:url value='/file/add-document-${sessionScope.userId}' />"><span> </span>Product</a></div>
