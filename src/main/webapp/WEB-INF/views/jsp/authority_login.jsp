...
<div class="container">
	<form:form method="post" action="${contextPath}/authority/login" modelAttribute="user">
		   ...
		   <div class=" login-right">
			...
			<form>
			  ...
			  <div>
				...
				<form:hidden path="role" value="authority"/>
			  </div><br/>
		    ...
		    <div class=" login-left">
			 ...
			 <a class="acount-btn" href="${contextPath}/authority/displayRegistration">Create an Account</a>
