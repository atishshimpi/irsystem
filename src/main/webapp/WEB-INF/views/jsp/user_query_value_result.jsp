...
<!---->
	<div class="container">
			<div class="shoes-grid">
				<form:form method="post" action="${contextPath}/search/queryvalue" modelAttribute="queryText">
				  ${message}
					<div>
			...
			<div>
			  <div class="slider">
	   		     ...
	   		     <div class="products">
<!-- 	   		     	<h5 class="latest-product">QUERY VALUE SEARCH RESULT</h5>	 -->
						<h5 class="latest-product">QUERY VALUE SEARCH RESULT</h5> <br /> <h5 class="latest-product"> RETRIVED PRODUCTS COUNT <input Value = "${userDocuments.size()}">  </h5>
	   		     	...
	   		     	<c:forEach items="${userDocuments}" var="doc" varStatus="counter">
		   		     	<div class="col-md-4 chain-grid">
		   		     		...
		   		     		<div class="grid-chain-bottom">
		   		     			<h6><a href="${contextPath}/search/user_product_details?id=${doc.id}"><span> </span>${doc.productName.substring(0,10)}...</a></h6>
