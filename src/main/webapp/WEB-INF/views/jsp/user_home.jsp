			     ...
			     <div class="product-left"  style="padding-bottom:20px;">
	   		     ...
	   		     <div class="products">
	   		     	<h5 class="latest-product">RECOMANDED PRODUCTS</h5>	
	   		     	  <a class="view-all" href="${contextPath}/user/view-all-products" >VIEW ALL<span> </span></a> 		     
	   		     	...
	   		     	<c:forEach items="${userDocuments}" var="doc" varStatus="counter">
		   		     	<div class="col-md-4 chain-grid">
		   		     		...
		   		     		<div class="grid-chain-bottom">
		   		     			<h6><a onclick="javascript:addVisit(${doc.id});" href="${contextPath}/search/user_product_details?id=${doc.id}"><span> </span>${doc.productName}</a></h6>
