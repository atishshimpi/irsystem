 ...
 <section class="container">
	<div class="login">
	  ...
	  <form method="post" action="index.html">
	   ...
	   ${message}
		 <form:form method="post" action="${contextPath}/authority/create" modelAttribute="authority">
			<table>
			    <tr>
			        <th>First Name : </th>
...
<div class="container">
	...
	<form:form method="post" action="${contextPath}/authority/create" modelAttribute="user">
	  ${message}
