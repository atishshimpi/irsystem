...
<!-- 	   		     	<h5 class="latest-product">QUERY VALUE SEARCH RESULT</h5>	 -->
					<h5 class="latest-product">MAPPING ATTRIBUTE VALUE ALGORITHM SEARCH RESULT</h5><h5 class="latest-product">RETRIVED PRODUCTS COUNT <input Value = "${userDocuments.size()}">  </h5>
