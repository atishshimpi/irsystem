...
<!---->
	<div class="container">
			<div class="shoes-grid">
				<form:form method="post" action="${contextPath}/search/contentvalue" modelAttribute="queryText">
				  ${message}
					<div>
			...
			<div>
			  <div class="slider">
	   		     ...
	   		     <div class="products">
	   		     	<h5 class="latest-product">CONTENT VALUE SEARCH RESULT</h5>	<br /> <h5 class="latest-product"> RETRIVED PRODUCTS COUNT <input Value = "${userDocuments.size()}">  </h5>		
