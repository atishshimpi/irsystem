...
<!---->
	<div class="container">
			<div class="shoes-grid">
				<form:form method="post" action="${contextPath}/search/querycontentvalue" modelAttribute="queryText">
				  ${message}
					<div>
...
<!-- 	   		     	<h5 class="latest-product">RECOMANDED PRODUCTS</h5>	 -->
					<h5 class="latest-product">COMBINATION OF QUERY AND CONTENT VALUE SEARCH </h5><h5 class="latest-product">RETRIVED PRODUCTS COUNT<input Value = "${userDocuments.size()}">  </h5>	
	   		     	...
	   		     	<c:forEach items="${userDocuments}" var="doc" varStatus="counter">
		   		     	<div class="col-md-4 chain-grid">
		   		     		...
		   		     		<div class="grid-chain-bottom">
		   		     			<h6><a href="single.html">${doc.productName}</a></h6>
